...
INCLUDES += -I$(FREERTOSPATH)/Source/include \
            -I$(FREERTOSPATH)/Source/portable/GCC/ARM_CM7/r0p1 \
...
ARCHFLAGS = -g -MD -MP -mcpu=cortex-m7 -mthumb -mfloat-abi=hard -mfpu=fpv5-sp-d16
...
CORECFLAGS = $(ARCHFLAGS) -Wall -Werror -Wno-unknown-pragmas \
             ...
             -D__FreeRTOS__ -DGCC_ARMCM7 -D_REENT_SMALL
...
LDFLAGS += -g -fdata-sections -ffunction-sections -T target.ld \
           ...
           -L$(STM32CUBEF7PATH)/Drivers/CMSIS/Lib/GCC \
